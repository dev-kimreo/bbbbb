 ...
 *      @OA\Property(
 *          property="status", type="string", example="waiting",
 *          description="처리상태<br/>waiting:접수<br/>answering:확인중<br/>answered:완료"
 *      ),
 ...
 *      @OA\Property(
 *          property="referrer", type="object", ref="#/components/schemas/UserSimply",
 *          description="문의계정으로 지정된 사용자 정보"
 *      ),
 *      @OA\Property(property="assignee", type="object", ref="#/components/schemas/UserSimply", description="처리담당자 정보"),
 *      @OA\Property(
 *          property="attachFiles", type="array", description="첨부파일",
 *          @OA\Items(ref="#/components/schemas/AttachFileSimply")
 *      ),
 *      @OA\Property(
 *          property="backofficeLogs", type="array", description="백오피스 업데이트 로그",
 *          @OA\Items(ref="#/components/schemas/BackofficeLog")
 *      ),
 *  )
 *
 *  @OA\Schema(
 ...
 *      @OA\Property(property="assignedAt", type="string", format="date-time", description="처리담당자 지정일자"),
 *      @OA\Property(
 *          property="createdAt", type="ISO 8601 date", example="2021-02-12T15:19:21+00:00", description="등록일자"
 *      ),
 *      @OA\Property(
 *          property="updatedAt", type="ISO 8601 date", example="2021-02-13T18:52:16+00:00", description="수정일자"
 *      ),
 *      @OA\Property(property="answered", type="boolean", example="true", description="답변완료 여부"),
 *      @OA\Property(
 *          property="answeredAt", type="boolean", example="2021-02-13T18:52:16+00:00",
 *          description="답변완료일 (답변이 없는 경우 null)"
 *      ),
 ...
 *      ),
 *      @OA\Property(
 *          property="assignee", type="object", ref="#/components/schemas/UserSimply",
 *          description="처리담당자의 사용자 정보"
 *      ),
 *  )
